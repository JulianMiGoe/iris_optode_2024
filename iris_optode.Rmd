...
#df_field_iris_long[,5] <- as.factor(df_field_iris_long[,5])    
#df_field_iris_long[,6] <- as.factor(df_field_iris_long[,6])    
#df_field_iris_long[,7] <- as.factor(df_field_iris_long[,7]) 
#df_field_iris_long[,3] <- as.factor(df_field_iris_long[,3])
#df_field_iris_long[,9] <- as.numeric(df_field_iris_long[,9])
...
df_optode_sa_long <- df_optode_sa %>%
  ...
  mutate(ROI = factor(ROI, levels = c("MeanROI1", "MeanROI3","MeanROI4", "MeanROI6"), labels = c("Root 1", "Root 2","Root 3", "Soil-control")))
...
df_optode_ap_long <- df_optode_ap %>%
  ...
  mutate(ROI = factor(ROI, levels = c("MeanROI2", "MeanROI3", "MeanROI4"), labels = c("Root 1", "Root 2", "Soil-control")))
